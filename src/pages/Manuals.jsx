        ...
        <div className="container">
          <Reveal>
            ...
            <p className="page-sub">
              We link directly to each manufacturer's official manual and documentation library —
              always the most accurate and current source for your exact model.
            </p>
          </Reveal>
          <Reveal delay={0.1}>
              ...
              <Reveal key={b.slug} delay={i * 0.07}>
                <a href={b.driverUrl} target="_blank" rel="noopener noreferrer" className="manual-card">
                  ...
                  <div className="manual-card-content">
                    ...
                    <p>Official setup guides, manuals, and specifications from {b.name}.</p>
          ...
          <Reveal>
            <div className="manual-tip">
              ...
              <div>
                ...
                <p>
                  Most manufacturer sites let you search by the model number printed on a label on the
                  front, top, or back of your printer. If you can't locate it, check the original box or
                  packing slip — the model number is usually printed there too.
                </p>
              </div>
            </div>
          </Reveal>
