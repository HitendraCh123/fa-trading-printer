        ...
        <div className="container">
          <Reveal>
            ...
            <p className="page-sub">
              Need extra help? Get in touch with our technical team. We support all major brands
              including HP, Epson, Canon, Brother, and Dell.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <Reveal>
            <div className="support-sidebar">
              ...
              <p className="sidebar-sub">
                If you've checked the manuals and diagnosis guide and are still facing issues,
              ...
              <div className="contact-cards">
                ...
                <div className="contact-card">
                  ...
                  <div>
                    ...
                    <p>Mon–Fri, 9am–6pm</p>
                    <span className="reply-tag">Phone support: 24/7</span>
                  </div>
                </div>
              </div>
            </div>
